...
angular.module('app').factory('RestTimeSeriesDataModel', function (settings, WidgetDataModel, $http) {
...
angular.module('app').factory('RestTopNDataModel', function (settings, WidgetDataModel, $http) {
...
angular.module('app').factory('MeteorTimeSeriesDataModel', function (settings, MeteorDdp, WidgetDataModel) {
...
angular.module('app').factory('MeteorDataModel', function (settings, MeteorDdp, WidgetDataModel) {
    function MeteorTimeSeriesDataModel() {
      var ddp = new MeteorDdp(settings.meteorURL); //TODO
      this.ddp = ddp;
...
angular.module('app').factory('WebSocketWidgetDataModel', function (WidgetDataModel, webSocket) {
...
angular.module('app').factory('RandomValueDataModel', function (WidgetDataModel, $interval) {
...
angular.module('app').factory('RandomTopNDataModel', function (WidgetDataModel, $interval) {
...
angular.module('app').factory('RandomTimeSeriesDataModel', function (WidgetDataModel, $interval) {
...
angular.module('app').factory('RandomD3TimeSeriesDataModel', function (WidgetDataModel, $interval) {
    function RandomTimeSeriesDataModel() {
    }
