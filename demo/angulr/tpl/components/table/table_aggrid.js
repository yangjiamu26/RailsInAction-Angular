...
angular.module("app").controller("AgGridCtrl", function($scope) {
    ...
    function skillsCellRenderer(params) {
        ...
        IT_SKILLS.forEach(function (skill) {
            if (data && data.skills[skill]) {
                skills.push('<img src="img/skills/' + skill + '.png" width="16px" title="' + skill + '" />');
            }
        });
        return skills.join(' ');
    }
    ...
    function countryCellRenderer(params) {
        var flag = "<img border='0' width='15' height='10' style='margin-bottom: 2px' src='img/flags/" + COUNTRY_CODES[params.value] + ".png'>";
    ...
    var SKILL_TEMPLATE =
        ...
        '    <div>' +
        '      <input type="checkbox"/>' +
        '      <img src="img/skills/SKILL.png" width="30px"/>' +
        '    </div>' +
        '  </span>' +
        '</label>';
