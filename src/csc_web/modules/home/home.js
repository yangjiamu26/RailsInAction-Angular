angular.module('home', ['ui.router']).config(
	[   
		'$stateProvider', 
		'$urlRouterProvider', 
		function ($stateProvider,   $urlRouterProvider) {
            ...
            .state('app.customhome', {
                url: '/customhome',
                templateUrl: 'modules/home/custom_index.html'
            })
		},
	]
)
.controller('homeCtrl', ['$scope','resStatistics','countOnIndex','expiredtodelete','areaResCount','productCount', function($scope,resStatistics,countOnIndex,expiredtodelete,areaResCount,productCount) {
    ...
    var pie = {
        "cpuPie":{"max":0,"used":0,"free":0},
        "memoryPie":{"max":0,"used":0,"free":0},
        "storagePie":{"max":0,"used":0,"free":0}
    };
    ...
    productCount.getproductCount(function(data){
        var productCategories = [],productData = [];
        var vdiskCategories = [],vdiskProductData = [];
