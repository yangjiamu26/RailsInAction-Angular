angular.module('service', ['ui.router']).config(
	[          '$stateProvider', '$urlRouterProvider', 
		function ($stateProvider,   $urlRouterProvider) {
        	...
        	.state('app.service.productlist', {
                	url: '/productlist',
                	templateUrl: 'modules/service/productlist.html',
            	}
        	)
        	.state('app.service.product', {
                	url: '/product',
                	templateUrl: 'modules/service/product.html',
        	...
        	.state('app.service.productlist-add-steps', {
                	...
                	templateUrl: 'modules/service/productlist-add-steps.html',
            ...
            .state('app.service.requisition', {
                    url: '/requisition',
                    templateUrl: 'modules/service/requisition.html'
                }
            )
            .state('app.service.requisitionlist', {
                    url: '/requisitionlist',
                    templateUrl: 'modules/service/requisitionlist.html'
                }
            )
            .state('app.service.requisition-detailed', {
                    url: '/requisition-detailed',
                    templateUrl: 'modules/service/requisition-detailed.html'
                }
            )
            .state('app.service.requis-steps', {
                    url: '/requis-steps',
                    templateUrl: 'modules/service/requis-steps.html',
            ...
            .state('app.service.requis-custom-steps', {
                    ...
                    templateUrl: 'modules/service/requis-custom-steps.html',
                    //controller:'appServiceRequisStepsCtrl',
                    resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
        	...
        	.state('app.service.constructionlist', {
                	...
                	templateUrl: 'modules/service/constructionlist.html',
        	...
        	.state('app.service.construction', {
                	url: '/construction',
                	templateUrl: 'modules/service/construction.html'
            	}
        	)
        	.state('app.service.pricesetup', {
                	url: '/pricesetup',
                	templateUrl: 'modules/service/pricesetup.html'
            	}
        	)
        	.state('app.service.billlist', {
                	url: '/billlist',
                	templateUrl: 'modules/service/billlist.html',
                	controller:'serviceBillCtrl'
            	}
        	)
        	.state('app.service.softwarelist', {
                	url: '/softwarelist',
                	templateUrl: 'modules/service/softwarelist.html'
            	}
        	)
        	.state('app.service.softwaretype', {
                	url: '/softwaretype',
                	templateUrl: 'modules/service/softwaretype.html'
            	}
        	)
        	.state('app.service.scriptlist', {
                	url: '/scriptlist',
                	templateUrl: 'modules/service/scriptlist.html'
            	}
        	)
        	.state('app.service.installlist', {
                	url: '/installlist',
                	templateUrl: 'modules/service/installlist.html'
            	}
        	)
        	.state('app.service.loglist', {
                	url: '/loglist',
                	templateUrl: 'modules/service/loglist.html',
...
.controller('appServiceCtrl', ['$scope', function($scope) {
...
.controller('proModalCtrl', ['$scope', '$modal', '$log', function($scope, $modal, $log) {
...
.controller('proAddStepsCtrl', ['$scope','$timeout', function($scope,$timeout) {
...
.controller('serviceProductHostListCtrl', ['$scope', '$filter','product', function($scope, $filter,product){
...
.controller('serviceProductStorageListCtrl', ['$scope', '$filter','product', function($scope, $filter,product){
...
.controller('serviceServerHostListCtrl', ['$scope', '$filter','server', function($scope, $filter,server){
...
.controller('serviceProductCtrl', ['$scope', '$filter', function($scope, $filter){
    $scope.serviceText = {
...
.controller('serviceCstlCtrl', ['$scope', function($scope) {
...
.controller('serviceBillCtrl', ['$scope', function($scope) {
    $scope.switchFilter = function(){
    	$('.adv-filter-btn').toggleClass('filterhasbg');
		$('.adv-filter-btn').find("span").toggleClass('rotate180');
		$(".adv-filter").toggleClass('hide');
...
.controller('serviceLogCtrl', ['$scope', function($scope) {
    $scope.switchFilter = function(){
    	$('.adv-filter-btn').toggleClass('filterhasbg');
		$('.adv-filter-btn').find("span").toggleClass('rotate180');
		$(".adv-filter").toggleClass('hide');
...
.controller('appServiceRequisStepsCtrl', ['$scope', function($scope) {
