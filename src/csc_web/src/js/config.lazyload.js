...
angular.module('app')
   ...
   */
  .constant('JQ_CONFIG', {
  	  highchart:      [   'bower_components/angular-highcharts/highcharts-ng.js'],
      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'ngZtree',
                  files: [
                      'bower_components/zTree_v3/metroStyle/metroStyle.css',
                      'bower_components/zTree_v3/jquery.ztree.all-3.5.min.js'
                  ]
              },
              {
                  name: 'ngJquerySteps',
                  files: [
                      'bower_components/jquery-steps/jquery.steps.js',
                      'bower_components/jquery-steps/jquery.steps.css'
                  ]
              },
              {
                  name: 'ngGrid',
