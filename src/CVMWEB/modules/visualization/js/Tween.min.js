...
TTTTT.Tween = function(a) {
	var c = {},
		...
		q = 0,
		m = null,
		w = TTTTT.Easing.Linear.None,
		x = TTTTT.Interpolation.Linear,
		n = [],
		r = null,
		s = !1,
		t = null,
...
TTTTT.Easing = {
	...
	Bounce: {
		In: function(a) {
			return 1 -
				TTTTT.Easing.Bounce.Out(1 - a)
		},
		Out: function(a) {
			return a < 1 / 2.75 ? 7.5625 * a * a : a < 2 / 2.75 ? 7.5625 * (a -= 1.5 / 2.75) * a + 0.75 : a < 2.5 / 2.75 ? 7.5625 * (a -= 2.25 / 2.75) * a + 0.9375 : 7.5625 * (a -= 2.625 / 2.75) * a + 0.984375
		},
		InOut: function(a) {
			return 0.5 > a ? 0.5 * TTTTT.Easing.Bounce.In(2 * a) : 0.5 * TTTTT.Easing.Bounce.Out(2 * a - 1) + 0.5
		}
	}
};
TTTTT.Interpolation = {
	Linear: function(a, c) {
		var b = a.length - 1,
			d = b * c,
			e = Math.floor(d),
			g = TTTTT.Interpolation.Utils.Linear;
	...
	Bezier: function(a, c) {
		var b = 0,
			d = a.length - 1,
			e = Math.pow,
			g = TTTTT.Interpolation.Utils.Bernstein,
			h;
	...
	CatmullRom: function(a, c) {
		var b = a.length - 1,
			d = b * c,
			e = Math.floor(d),
			g = TTTTT.Interpolation.Utils.CatmullRom;
	...
	Utils: {
		...
		Bernstein: function(a, c) {
			var b = TTTTT.Interpolation.Utils.Factorial;
