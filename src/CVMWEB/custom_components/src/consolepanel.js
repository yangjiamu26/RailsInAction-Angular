...
function ConsolePanel(){
	...
	this.initEvent = function(canvas){
		...
		//上下左右的键盘监听
		var body = document.getElementById("ctopobox");
		...
		//比例尺滑块的鼠标滑轮监听
    	canvas.addEventListener("mousewheel",scrollSlider,false); 	//IE,chorme
		canvas.addEventListener("DOMMouseScroll",scrollSlider,false); //firefox
		//比例尺滑块的拖拽监听
