myApp.onPageInit("vm-list", function(page) {
  function ViewModel(){
    var self=this;
    this.title = ko.observable(page.query.title)
    ...
    this.loadData = function(searchVal,is_loadMore){
      ...
      RestServiceJs.query(url,{"dcId":CVM_IPHONE.dcId,"name":searchVal,"hypervisor":page.query.hypervisor || '',"resourcePoolId":resourcePoolId,"firstResult":(self.page-1)*PAGE_SIZE,"maxResult":PAGE_SIZE},function(data){
        self.loading = false;
        if(!is_loadMore){
