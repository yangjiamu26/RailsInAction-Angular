myApp.onPageInit("host-list-search", function(page) {
  function ViewModel(){
    ...
    this.loadData = function(is_loadMore){
      ...
      RestServiceJs.query(BASE_URL+"/host",{"dcId":CVM_IPHONE.dcId,"hypervisor":self.hypervisor(),"resPoolId":self.resPoolId(),"firstResult":(self.page-1)*PAGE_SIZE,"maxResult":PAGE_SIZE},function(data){
