  ...
  function ViewModel(){
    ...
    this.setPoolSelected = function(object,event){
      ...
      if(page.query.forPage == 'vm'){
        window.vmIndexVO.loadData(false, self.hypervisor(), id);
      }
    ...
    this.loadData = function(is_loadMore){
      ...
      RestServiceJs.query(BASE_URL+"/resPool",{"dcId":CVM_IPHONE.dcId,"hypervisor":self.hypervisor(), "firstResult":(self.page-1)*PAGE_SIZE,"maxResult":PAGE_SIZE},function(data){
