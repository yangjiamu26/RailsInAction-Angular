app.controller('MalharDashboardCtrl', function ($scope, $interval, stackedAreaChartSampleData, pieChartSampleData, RandomTimeSeriesDataModel, RandomTopNDataModel) {
    var widgetDefinitions = [
      ...
      {
        name: 'progressbar2',
        template: '<div uib-progressbar class="progress-striped" type="info" value="percentage">{{percentage}}%</div>',
        style: {
          width: '30%'
        }
      },
