...
// Fonts
var NORMAL_FONT = {font: "10px 宋体", opacity: 1, fill: Color.black};
var LABEL_FONT = {font: "11px 宋体", "font-style":"italic", opacity: 1, "fill": LABEL_COLOR};
var LABEL_FONT_SMOOTH = {font: "10px 宋体", "font-style":"italic", opacity: 1, "fill": LABEL_COLOR, stroke: LABEL_COLOR, "stroke-width":.4};
var TASK_FONT = {font: "11px 宋体", opacity: 1, fill: Color.black};
var TASK_FONT_SMOOTH = {font: "11px 宋体", opacity: 1, fill: Color.black, stroke: LABEL_COLOR, "stroke-width":.4};
var POOL_LANE_FONT = {font: "11px 宋体", opacity: 1, fill: Color.black};
var EXPANDED_SUBPROCESS_FONT = {font: "11px 宋体", opacity: 1, fill: Color.black};
