...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    ...
    construct: function(source, modelMetaData, editorId){
		...
		if(ORYX.CONFIG.BACKEND_SWITCH) {
			...
			/*new Ajax.Request(CscRest.getBaseUrl("csc.service.workflow.getEditorStencilset") + "&version=" + Date.now(), {*/
			new Ajax.Request("/csc/editor-app/i18n/stencilset_zh_CN.json?version=" + Date.now(), {
	            asynchronous: false,
	            method: 'get',
