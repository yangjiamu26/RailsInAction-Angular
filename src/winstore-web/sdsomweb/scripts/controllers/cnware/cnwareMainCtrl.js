...
vsanApp.controller('cnwareMainCtrl',function($scope,mainFactory,cnwareFactory){
    //请求存储池数量
    cnwareFactory.queryCNwarePool({pagesize: 100, pageno: 1}, function (res) {
        if (res.data != null) {
    ...
    //请求lun数量
    cnwareFactory.queryCNwareLun({pagesize: 100, pageno: 1}, function (res) {
