...
function popoverClose(event){
  ...
  view_home.router.load({           url: "tpl/home/index.html?id="+datacenter_id,animatePages: false});  
  view_business.router.load({       url: "tpl/business/index.html?id="+datacenter_id,animatePages: false});
  view_pool.router.load({           url: "tpl/pool/index.html?id="+datacenter_id,animatePages: false});
  view_host.router.load({           url: "tpl/host/index.html?id="+datacenter_id,animatePages: false});
  view_vm.router.load({             url: "tpl/vm/index.html?id="+datacenter_id,animatePages: false});
  view_storage.router.load({        url: "tpl/storage/index.html?id="+datacenter_id,animatePages: false});    
  view_settings_left.router.load({  url: "tpl/settings/index.html?id="+datacenter_id,animatePages: false});
  view_settings_right.router.load({ url: "tpl/settings/profile.html?id="+datacenter_id,animatePages: false});
