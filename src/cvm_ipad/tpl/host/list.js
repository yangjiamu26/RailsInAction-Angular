myApp.onPageInit("host-list", function(page) {
  ...
  function ViewModel(){
    ...
    this.loadData = function(is_loadMore, hypervisor, resPoolId){
      ...
      RestServiceJs(BASE_URL+"/resPool/"+page.query.id+"/host").query({"dcId":CVM_PAD.dcId,"hypervisor":this.hypervisor(),"firstResult":(self.page-1)*PAGE_SIZE+1,"maxResult":self.page*PAGE_SIZE},function(data){
