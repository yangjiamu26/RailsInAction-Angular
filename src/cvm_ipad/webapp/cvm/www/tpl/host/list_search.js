myApp.onPageInit("host-list-search", function(page) {
  function ViewModel(){
    ...
    this.loadData = function(is_loadMore){
      ...
      RestServiceJs(BASE_URL+"/host").query({"dcId":CVM_PAD.dcId,"hypervisor":self.hypervisor(),"resPoolId":self.resPoolId(),"firstResult":(self.page-1)*PAGE_SIZE,"maxResult":self.page*PAGE_SIZE-1},function(data){
